      ...
      <div className="homeContainer">
          ...
          <div className="rightContainer">
            ...
            >
              ...
              <polygon
                ...
                fill="#fff"
              />
              <circle cx="557.53" cy="274.45" r="12.38" fill="#00bfa6" />
              <path
              ...
              <polygon
                ...
                fill="#fff"
              />
              <circle cx="838.46" cy="229.08" r="8.38" fill="#00bfa6" />
              <path
              ...
              <polygon
                ...
                fill="#fff"
              />
              <circle cx="265.3" cy="229.08" r="8.38" fill="#00bfa6" />
              <path
        ...
        <div className="secondContainer">
          ...
          <span className="secondDescription">
            Established in 2024, GreenWise Home Initiatives has made its mark as
            a leader of increasing green energy awareness. GreenWise has left
            customers with smiles on their faces and a smaller energy bill, time
            and time again. Let GreenWise lead you to make the right choice, the
            green choice!
          </span>
        </div>
        <div className="thirdContainer">
          <span className="thirdTitle">Our Mission</span>
          <span className="thirdDescription">
            We want to give our users the best possible experience when choosing
            to go green. Our goal is to give people informed to make sure that
            they can make the most informed decisions, while being affordable
            and easy!
          </span>
        </div>
        <div onClick={routeChange} className="fourthContainer">
          <span className="fourthTitle">Hesitant on Switching?</span>
          <div className="readyToGetStartedBtn">Learn More</div>
        </div>
      </div>
      <Footer />
    </>
