...
const WhyGreen = () => {
  ...
  return (
    <>
      <Header />
      <div className="whyGreenContainer">
        <span className="whyGreenText">Why Choose Green Energy?</span>
      </div>
      <div className="greenInfo">
        <span className="greenInfoTitle">What is Green Energy?</span>
        <span className="greenInfoDescription">
          Green energy is an alternate energy generated from natural resources,
          such as sunlight, wind, or water and it causes no harm to the
          environment. These green energy sources are safer for the environment,
          as they do not burn high carbon fossil fuels to generate electricity.
          Additionally, they are renewable and are not dependent on a limited
          supply of fossil fuels. There are many different types of green
          energies.
        </span>
      </div>
      <div className="whyGoGreenContainer">
        <div className="leftGoGreenContainer">
          <span className="whyGoGreenTitle">Why Go Green?</span>
          <ul className="whyGoGreenDescription">
            <li>Produces zero carbon emissions</li>
            <li>Cheaper form of electricity</li>
            <li>Reduces waste</li>
            <li>Reduces air and water pollution</li>
            <li>Reduces the need to rely on other places for energy</li>
          </ul>
        </div>

        <div className="rightGoGreenContainer">
          <svg
            data-name="Layer 1"
          ...
          >
            ...
            <path
              ...
              fill="#00bfa6"
            />
            <circle cx="437.84782" cy="427.99201" r="17.48305" fill="#00bfa6" />
      ...
      <div className="differentTypesOfEnergyContainer">
        ...
        {solarDropdown ? (
          <span className="differentTypesOfEnergyDropdownDescription">
            ...
            on top of roofs, placed on the ground or attached to moving objects.
            Solar has been used to power homes, air conditioning, dryers and
            various other applications. It has also been used by NASA to power
            their satellites.
          </span>
        ) : (
          <></>
        ...
        {windDropdown ? (
          <span className="differentTypesOfEnergyDropdownDescription">
            ...
            generator. These windmills are usually 80 meters (260 ft) tall in
            order for the wind to move the three fans attached to the rotor
            which moves the generator, producing electricity.
          </span>
        ) : (
          <></>
        )}
